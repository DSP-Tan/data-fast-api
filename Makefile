...
curl_predict:
	@printf "\n\n" && curl -X 'GET' 'http://127.0.0.1:8000/predict?pickup_datetime=2013-07-06%2017%3A18%3A00&pickup_longitude=-73.950655&pickup_latitude=40.783282&dropoff_longitude=-73.950655&dropoff_latitude=40.783282&passenger_count=2' \
  -H 'accept: application/json' && printf "\n\n\n"

curl_cloud_run:
	@printf "\n\n" && curl -X 'GET' 'https://taxifart-lpuaioudtq-ew.a.run.app/predict?pickup_datetime=2013-07-06%2017%3A18%3A00&pickup_longitude=-73.950655&pickup_latitude=40.783282&dropoff_longitude=-73.950655&dropoff_latitude=40.783282&passenger_count=2' \
  -H 'accept: application/json' && printf "\n\n\n"
